        ...
        <article className="space-y-8 sm:space-y-10">
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="docs-surface p-5 sm:p-6 md:p-8">
              ...
              <h1 className="mt-4 max-w-4xl text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl md:text-4xl">Sosyal Medya Linkleri</h1>
              <p className="mt-4 max-w-3xl text-sm leading-7 text-gray-600 sm:text-base">Sosyal medya kaynaklarını merkezi ve yönetilebilir tabloda toplayın.</p>
              <div className="mt-6 flex flex-wrap gap-3 text-sm text-gray-500">
                <span className="docs-chip">social_media_links tablosu</span>
                <span className="docs-chip">9 platform</span>
              </div>
            </div>
          </div>
          <SocialMediaManager />
