...
import AdvisorSocialMediaManager from '@/components/advisorsocialmedia/AdvisorSocialMediaManager'

export default function DanismanlarSmPage() {
  return (
    <DocsShell>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="docs-surface p-5 sm:p-6 md:p-8">
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-gray-600 sm:text-base">
                Danışman ve sosyal medya odaklı kaynakları ayrı tabloda merkezi olarak yönetin.
              </p>
              <div className="mt-6 flex flex-wrap gap-3 text-sm text-gray-500">
                <span className="docs-chip">advisor_social_media_links tablosu</span>
