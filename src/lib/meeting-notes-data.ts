...
export const MEETING_CATEGORIES: MeetingNoteCategory[] = [
  { id: 'platform-vizyon', label: 'Platform Vizyonu & Strateji', color: '#4285F4' },
  { id: 'teknik', label: 'Teknik Geliştirme & Altyapı', color: '#34A853' },
  { id: 'pazarlama', label: 'Pazarlama & Büyüme', color: '#EA4335' },
  { id: 'ekip', label: 'Ekip & Operasyon', color: '#FBBC04' },
  { id: 'marka', label: 'Marka & Domain', color: '#A142F4' },
  { id: 'finans', label: 'Finans & Gelir Modeli', color: '#FA7B17' },
  { id: 'ai', label: 'AI & Dijital İkiz', color: '#00897B' },
  { id: 'network', label: 'Network & Ortaklıklar', color: '#E91E63' },
]
